...
use \ariuspay\Gateway\HTTPRequest  as HTTPRequest;
use \ariuspay\Gateway\HTTPResponse  as HTTPResponse;
class BaseConnector extends \ariuspay\ariuspay implements \ariuspay\Interfaces\IConnector{
    protected $_request;
    protected $_response;
    /*******************************************************************************
    ...
    public function response($data){
        ...
        if(!isset($this->_response_data["type"])){
            throw new ariuspayGatewayAruispayException(
                "Unknown message",
                500
            );
        }
    ...
    public function call2(){
        ...
        if(!isset($this->_response_data["type"])){
            throw new ariuspayGatewayAruispayException("Error in response. Wrong format",500);
        }
    ...
    public function query($url,$data = null){
        ...
        ariuspay::debug("RAW RESPONSE:[{$response}]");
        return $response;
    }
